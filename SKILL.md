...
# 读取师门纪律邮件
python3 mail163_tool.py --email YOUR_EMAIL@163.com --auth-code YOUR_AUTH_CODE read 32 -o /tmp/shimen.json

# 搜索龙族相关邮件
python3 mail163_tool.py --email YOUR_EMAIL@163.com --auth-code YOUR_AUTH_CODE search 龙 -o /tmp/dragon.json

# 下载港股IPO提醒技能
python3 mail163_tool.py --email YOUR_EMAIL@163.com --auth-code YOUR_AUTH_CODE download 35 hk-ipo
...
```json
{
  ...
  "from": "sender@example.com",
  "to": "recipient@163.com",
  "date": "2026-04-30 17:49",
  "subject": "【师门纪律】收到任务先回应...",
  "body": "师父、各位师兄弟：\n\n大家好...",
  "attachments": []
}
```
